    ...
    class wss extends prev {
        ...
        async init() {
            ...
            this.add({
                ...
                fn: async({params: {connectionId, a}}) => {
                    const [, connection] = connectionId.split('.');
        ...
        bindEvents(wsClient, {connectionId}) {
            ...
            wsClient.on('error', () => wsClient.terminate());
                    ...
                    if (!decoded.id) {
                        (async() => {
                            try {
                                ...
                                this.log('error', 'Wss.server.message', e);
                            }
                        })();
                        return;
                    }
        ...
        async initWssServer() {
            return await (new Promise((resolve, reject) => {
                ...
                this.wssServer.on('connection', async(wsClient, req) => {
                    ...
                    this.add({
                        name: `${this.nodeId}.${connectionId}.write`,
